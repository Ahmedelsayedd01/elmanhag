...
const AddAffiliatePaymentMethodPage = () => {
       ...
       const handleSubmitAdd = async (event) => {
              ...
              try {
                     ...
                     const response = await axios.post('http://62.84.185.153/plesk-site-preview/bcknd.elmanhag.com/https/62.84.185.153/admin/affilate/affilateMethodAdd', formData, {
                            headers: {
