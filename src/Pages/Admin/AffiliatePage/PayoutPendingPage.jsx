...
const PayoutPendingPage = () => {
       ...
       if (!pending) {
              return <div className='text-mainColor text-2xl font-bold w-full h-full flex items-center justify-center'>No pending data available</div>;
       }
       return (
              <>
                                          ...
                                          <tbody className="w-full">
                                                 {pending.map((pending, index) => (
                                                        <tr className="w-full border-b-2" key={pending.id}>
                                                               ...
                                                               >
                                                                      {pending.status === 1 ? <span className='text-green-500'>Active</span> : <span className='text-mainColor'>Unactive</span>}
                                                               </td>
                                                        </tr>
                                                 ))}
                                          </tbody>
