...
const HomeWorkPage = () => {
  ...
  //   setIsLoading(true);
  //   try {
  //     const response = await axios.get('https://bdev.elmanhag.shop/admin/', {
  //       headers: {
  ...
  //     setSubjectsChanged(!subjectsChanged)
  //   } else {
          ...
          <div className="w-full flex flex-wrap items-center justify-start gap-4">
                    <div className="sm:w-full xl:w-1/5">
                          <DropDownMenu
                                  ...
                                  // options={homeWorks.map(homeWork => ({ name: homeWork?.semester || 'N/A' }))}
                          />
                    </div>
                    <div className="sm:w-full xl:w-1/5">
                          <DropDownMenu
                    ...
                    <div className="sm:w-full xl:w-1/5">
                          <DropDownMenu
                                  ...
                                  // options={homeWorks.map(homeWork => ({ name: homeWork.category?.name || 'N/A' }))}
                          />
                    </div>
                    <div className="sm:w-full xl:w-1/5">
                          <DropDownMenu
                                  ...
                                  // options={homeWorks.map(homeWork => ({ name: homeWork.status===1?"Active" :"Disable" || 'N/A' }))}
                                  // options={homeWorks.status || []}
                ...
                {/* <tbody className="w-full">
                        {homeWorks.map((homeWork, index) => (
                              ...
                              <tr className="w-full border-b-2" key={homeWork.id}>
                                      ...
                                      >
                                            {homeWork.price_discount == undefined ? `${homeWork?.price || 'null'}` :
                                                    <>
                                                          <del className='text-mainColor'>{homeWork?.price || 'Null'}</del>  / {homeWork?.price_discount || 'Null'} EGP
                                                    </>
                                            }
                                      </td>
                                      <td
                                      ...
                                      >
                                            <span className='text-thirdColor text-xl border-b-2 border-thirdColor'>
                                                    <Link to={`students/${homeWork.id}`}>
                                                          {homeWork?.users_count || 'Null'}
                                                    </Link>
                                            </span>
                                      </td>
                                      <td
