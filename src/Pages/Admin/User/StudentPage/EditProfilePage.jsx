...
const EditProfilePage = () => {
       ...
       useEffect(() => {
              const fetchStudentProfile = async () => {
                     setIsLoading(true);
                     try {
                            const response = await axios.get(`http://62.84.185.153/plesk-site-preview/bcknd.elmanhag.com/https/62.84.185.153/admin/student/student/${profileStudentId}`, {
                                   headers: {
       ...
       const handleEditStudent = async (e) => {
              ...
              try {
                     const response = await axios.post(`http://62.84.185.153/plesk-site-preview/bcknd.elmanhag.com/https/62.84.185.153/admin/student/update/${profileStudentId}`, formData, {
                            headers: {
                                   Authorization: `Bearer ${auth.user.token}`,
