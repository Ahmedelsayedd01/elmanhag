...
const StudentPage = () => {
       ...
       const fetchStudents = async () => {
              setIsLoading(true);
              try {
                     const response = await axios.get('http://62.84.185.153/plesk-site-preview/bcknd.elmanhag.com/https/62.84.185.153/admin/student', {
                            headers: {
       ...
       const handleStatus = async (studentId, studentName, status) => {
              try {
                     const response = await axios.put(`http://62.84.185.153/plesk-site-preview/bcknd.elmanhag.com/https/62.84.185.153/admin/student/status/${studentId}`, { status }, {
                            headers: {
                                   Authorization: `Bearer ${auth.user.token}`,
                            },
                     });
