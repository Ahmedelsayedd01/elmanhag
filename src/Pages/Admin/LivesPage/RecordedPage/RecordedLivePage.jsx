       ...
       const fetchLivesRecorded = async () => {
              ...
              try {
                     ...
                     if (response.status === 200) {
                            ...
                            setLivesRecorded(response.data.live_recorded);
                     }
              } catch (error) {
                                                        ...
                                                        <tbody className="w-full">
                                                               {livesRecorded.map((live, index) => (
                                                                      <tr className="w-full border-b-2" key={live.id}>
                                                                             ...
                                                                             <td className="min-w-[150px] sm:min-w-[200px] sm:w-2/12 lg:w-2/12 py-2 text-center text-thirdColor text-sm sm:text-base lg:text-lg xl:text-xl overflow-hidden">
                                                                                    {live?.video_link ? (
                                                                                           <video src={live.video_link} controls className="w-full h-32 rounded-xl" controlsList="nodownload">
...
export default RecordedLivePage;
