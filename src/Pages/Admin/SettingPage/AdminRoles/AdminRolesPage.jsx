...
const AdminRolesPage = () => {
       ...
       const fetchRoles = async () => {
              setIsLoading(true);
              try {
                     const response = await axios.get("https://bdev.elmanhag.shop/admin/adminRole", {
                            headers: {
       ...
       const deleteRole = async (roleId, authToken) => {
              try {
                     const response = await axios.delete(`https://bdev.elmanhag.shop/admin/adminRole/delete/${roleId}`, {
                            headers: {
                     ...
                     <div className="w-full">
                                   ...
                                   <table className="w-full sm:min-w-0  border-collapse">
                                          <thead className="w-full">
                                                 <tr className="w-full border-b-2">
                                                        ...
                                                        <th className="min-w-[120px] sm:w-[18%] lg:w-[14%] text-mainColor text-center font-medium text-xs sm:text-sm lg:text-base xl:text-lg pb-3">Role Name</th>
                                                        <th className="min-w-[120px] sm:w-[18%] lg:w-[14%] text-mainColor text-center font-medium text-xs sm:text-sm lg:text-base xl:text-lg pb-3">Role Premissions</th>
                                          ...
                                          <tbody className="w-full">
                                                 {rolesData.map((roles, index) => (
                                                        <tr className="w-full border-b-2" key={roles.id}>
                                                               <td
                                                               ...
                                                               >
                                                                      <div className="flex items-center justify-center gap-x-3">
                                                                             <Link to={`edit/${roles.id}`} state={roles.id} type="button">
                                                                                    <EditIcon />
                                                                             </Link>
                                                                             <button type="button" className='outline-0' onClick={() => handleOpenDialog(roles.id)}>
                                                                                    <DeleteIcon />
                                                                             </button>
                                                                             {openDialog === roles.id && (
                                                                                                  ...
                                                                                                  <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                                                                                                         <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                                                                                                ...
                                                                                                                <div className="px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                                                                                                       <button
                                                                                                                              type="button"
                                                                                                                              onClick={() => handleDelete(roles.id, roles.name)}
                                                                                                                              disabled={isDeleting}
                            ...
                            <div className="w-full flex items-center justify-between mt-4 overflow-x-auto">
                                   <table className="w-full sm:min-w-0 border-collapse">
                                          <thead className="w-full">
                                                 <tr className="w-full border-b-2">
                                                        <th className="min-w-[80px] sm:w-1/12 lg:w-[8%] text-mainColor text-center font-medium text-xs sm:text-sm lg:text-base xl:text-lg pb-3">
                                                               #
                                                        </th>
                                                        <th className="min-w-[120px] sm:w-[18%] lg:w-[14%] text-mainColor text-center font-medium text-xs sm:text-sm lg:text-base xl:text-lg pb-3">
                                                               Role Name
                                                        </th>
                                                        <th className="min-w-[120px] sm:w-[18%] lg:w-[14%] text-mainColor text-center font-medium text-xs sm:text-sm lg:text-base xl:text-lg pb-3">
                                                               Role Permissions
                                                        </th>
                                                        <th className="min-w-[100px] sm:w-[8%] lg:w-[6%] text-mainColor text-center font-medium text-xs sm:text-sm lg:text-base xl:text-lg pb-3">
                                                               Action
                                                        </th>
                                                 </tr>
                                          </thead>
