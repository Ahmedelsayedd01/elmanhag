...
const AddVideoIssuesPage = () => {
       ...
       const handleSubmit = async (e) => {
              ...
              try {
                     ...
                     const response = await axios.post('http://62.84.185.153/plesk-site-preview/bcknd.elmanhag.com/https/62.84.185.153/admin/Settings/videoIssues/add', formData, {
                            headers: {
                     ...
                     if (response.status === 200) {
                            handleGoBack();
                            auth.toastSuccess("Video Issues Added Successfully!");
                     }
              } catch (error) {
...
export default AddVideoIssuesPage