...
const QuestionsBankPage = () => {
       ...
       const handleDelete = async (questionId) => {
              ...
              if (success) {
                     auth.toastSuccess('question deleted successfully!');
                     setQuestionsChanged(!questionsChanged)
              } else {
                     auth.toastError('Failed to delete question.');
              }
       };

       const deleteQuestion = async (questionId, authToken) => {
              try {
                     const response = await axios.delete(`https://bdev.elmanhag.shop/admin/question/delete/${questionId}`, {
                            headers: {
