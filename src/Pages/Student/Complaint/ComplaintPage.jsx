...
//                 const response = await axios.post('https://bdev.elmanhag.shop/student/complaint/store', formData, {
//                   headers: {
...
//                             <p className="font-almarai text-[36px] leading-[54px] font-normal text-right capitalize text-[#7E7D7D]">
//                                    نحن نقد ملاحظاتك واسمحوا لنا ان نعرف شكواك او اقتراحاتك
//                             </p>

//                             <div className="lg:w-1/3 md:w-full mt-4">
//                                    <InputCustom
//                                    type="text"
//                                    placeholder="اكتب اقتراحك او شكوتك هنا "
//                                    value={problem}
