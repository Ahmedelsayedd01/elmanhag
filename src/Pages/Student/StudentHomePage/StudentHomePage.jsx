    ...
    return (
        <>
            ...
            <div className="mt-12 text-center">
                <h1 className="text-2xl sm:text-4xl font-bold mb-8 text-gray-800">حمل التطبيق الان</h1>
                <div className="flex flex-wrap justify-center gap-8">
                    {/* Android Download */}
                    <div className="w-36 sm:w-44 h-36 sm:h-44 bg-mainColor rounded-full shadow-lg flex flex-col items-center justify-center hover:scale-110 transform transition duration-300 ease-in-out cursor-pointer">
