...
//   useEffect(() => {
//     // Fetch the subject data from local storage
...
//           if (error.response.data && error.response.data.lesson_not_solved) {
//             setErrorMessage('The previous lesson was not solved. Please complete the previous lesson first.');
//           } else {
...
//     // Set mainResource when lessons are fetched and resources are available
...
//             {/* Main Details */}
//             <div className="mt-4">
//               <h4 className="text-lg font-semibold">{chapterName}</h4>
...
import { Button } from '../../../Components/Button'
import { IoIosArrowDown } from 'react-icons/io'
>>>>>>> cf239feaae866b83caf6810a49826be228e6af5f
import { useNavigate } from 'react-router-dom';
