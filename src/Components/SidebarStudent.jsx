...
const SidebarStudent = ({ isOpen }) => {
    return (
        <aside
            className={`fixed lg:w-1/5 sm:w-3/5 z-10 h-screen right-0 overflow-hidden flex flex-col items-center bg-mainColor gap-y-3 transition-transform transform ${
